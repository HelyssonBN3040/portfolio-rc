      ...
      <MagicMotion>
        ...
        <div className='flex flex-wrap justify-around mt-20 mb-20 gap-10 items-center'>
          ...
          <div className="about">
            ...
            <p className='text-justify'>👋Me chamo Helysson Cavalcante Bentes do Nascimento, mas pode me chamar só de Helysson. Prazer!</p>
            <div className='mt-5 mb-5'>
              <p className='text-justify'>👨‍💻Pouco tempo na área de desenvolvimento e programando interfaces com  javaScript e React.</p>
